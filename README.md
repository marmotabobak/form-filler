...
4. При необходимости можно отключить автозаполнение тумблером «Включить автозаполнение» в попапе (по умолчанию включено).
5. Расширение заполнит только те поля, которые вы задали в попапе; при успехе наблюдатель остановится.
